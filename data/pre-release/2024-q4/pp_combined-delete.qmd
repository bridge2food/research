...
::: {.valuebox icon="filetype-pdf" color="light"}
December 9, 2024
```{=html}
<br><a style="font-size: 2.5rem; text-decoration: none;" href="https://research.bridge2food.com/data/downloads/2024Q4PPCombined.pdf" target="_blank">2024 Q4 Release Summary</a>
```
...
<div class="card mb-3" style="max-width: 540px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="/assets/images/db.jpg" class="img-fluid rounded-start" alt="plant protein combined dashboards">
    </div>
    <div class="col-md-8">
      <div class="card-body">
