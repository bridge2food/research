...
[Register interest](https://qualtricsxmgtnmmghg4.qualtrics.com/jfe/form/SV_a2UplqKqiQXYWEe) in participating in upcoming data periods.
...
<div class="card mb-3" style="max-width: 540px; position: relative;">
  <div class="d-flex flex-row align-items-center">
    ...
    <div class="card-body">
      <h5 class="card-title">Plant Protein Combined Surveys Q4 2024 Release Summary</h5>
      <p class="card-text">
        Summary of aggregated data from the PPUS, PMP, and PDP industry surveys.
      </p>
